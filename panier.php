...
?>
    ...
    <?php if(isset($msg)): ?>
        <p class="bg-success col-md-6 mx-auto p-3 text-center text-white my-3 disparition"><?= $msg; ?></p>
    <?php endif; ?>
        ...
        <div class="container col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 p-0 text-end mb-5">
            ...
            <?php if(connect()): ?>
                ...
                <form action="" method="post">
                    <input type="submit" class="btn btn-dark" name="payer" value="FINALISER LA COMMANDE" onclick="return(confirm('Voulez-vous réellement valider la commande ?'))">
                </form>
