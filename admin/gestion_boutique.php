                ...
                <?php if($key != 'id_article'): ?>
                    ...
                    <?php if($key == 'photo'): ?>
                        ...
                        <td class="d-flex flex-column align-items-center">
                            ...
                            <small class="text-success fst-italic">Cliquer pour agrandir</small>
                        </td>
...
<?php if(isset($_GET['action']) && $_GET['action'] == 'affichage'): ?>
    ...
    <?php if(isset($msg)): ?>
        <p class="bg-success col-6 mx-auto p-3 text-center text-white my-3 shadow-sm disparition"><?= $msg; ?></p>
    <?php endif; ?>
            ...
            <?php foreach($articles as $tab): ?>
                ...
                <?php foreach($tab as $key => $value): ?>
                    ...
                    <?php elseif($key == 'description' && iconv_strlen($value) > 50): ?>
                        ...
                        <td class="text-start"><?= substr($value, 0, 50); ?>[...]</td>
...
<?php if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification')): ?>
    ...
    <form method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-12">
            ...
            <textarea class="form-control editor" rows="10" id="editor" name="description"><?php if(isset($description)) echo $description; ?></textarea>
        </div>
        <div class="col-md-6">
        ...
        <?php if(isset($photo) && !empty($photo)): ?>
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <a href="<?= $photo; ?>" data-lightbox="image-modif" data-title="<?php if(isset($titre)) echo $titre; ?>" data-alt="<?php if(isset($titre)) echo $titre; ?>" class="d-flex align-items-center shadow-sm">
