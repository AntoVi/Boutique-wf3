...
?>
    ...
    <?php if(isset($_SESSION['validation_inscription'])): ?>
        <p class="bg-success col-md-5 mx-auto p-3 text-center text-white mt-3 disparition"><?= $_SESSION['validation_inscription']; ?></p>
    <?php endif; ?>

    <?php if(isset($error)): ?>
        <p class="bg-danger col-md-3 mx-auto p-3 text-center text-white mt-3 disparition"><?= $error; ?></p>
    <?php endif; ?>
